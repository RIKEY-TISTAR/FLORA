...
<div class="">
 ...
 <a wire:navigate href="{{ route('single.products', $data->slug) }}">
                    ...
                    <div class="p-4 flex-grow">
                        <h3 class="font-semibold text-lg mb-2 text-gray-800 hover:text-[#EE046C] transition-colors">{{ $data->name }}</h3>
                    ...
                    <button wire:click="$dispatch('add-to-cart', {productId: {{ $data->id }} })"
                        class="m-4 mt-0 bg-[#EE046C] hover:bg-black text-black cursor-pointer hover:text-[#EE046C] px-4 py-3 rounded-full font-medium transition-colors duration-300 flex items-center justify-center"
                        type="button">
