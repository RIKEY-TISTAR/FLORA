<div x-show="cartOpen"
            ...
            <div class="ml-4 flex-1">
                ...
                <div class="flex items-center mt-2">
                    <button wire:click="decrement({{ $product->id }})"
                        class="text-gray-500 hover:text-[#EE046C] p-1">
   ...
   <div x-data="{ phoneMask: null }" x-init="phoneMask = IMask(document.getElementById('phone'), {
    ...
    <input wire:model="phone"
           ...
           class="w-full px-4 py-2 border border-gray-300 rounded-md">
            ...
            <button wire:click="checkout"
                class="w-full bg-[#EE046C] text-white py-3 px-4  hover:bg-black transition-colors duration-200 flex items-center justify-center">
    ...
    <div class="text-center py-8">
        ...
        <a href="{{ route('page.products') }}" class="mt-4 inline-block text-[#EE046C] ">
            Перейти в каталог →
        </a>
    </div>
    @endif
