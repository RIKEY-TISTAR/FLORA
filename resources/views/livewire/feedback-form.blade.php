<div class="w-full h-full mx-auto p-6 text-white">
    ...
    <form class="flex flex-col justify-center items-center" wire:submit.prevent="submit">
        ...
        <button type="submit"
            class="mt-[32px] btn btn--primary relative inline-flex rounded-full items-center justify-center overflow-hidden px-[40px] py-[12.5px] bg-[#EE046C] text-white font-medium transition-all duration-300 ease-[cubic-bezier(.77,.14,.11,.88)] group">
